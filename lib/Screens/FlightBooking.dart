...
class _BookingScreenState extends State<BookingScreen> {
  ...
  int _noInfants=0;
  int _noChild=0;
  List<IconData> icons=[Icons.check_circle,Icons.radio_button_unchecked,Icons.radio_button_unchecked];
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      GestureDetector(
                                        child: Icon(icons[0],color: Colors.green[900],size: 30,),
                                        onTap: (){
                                          updateClass(state, 1);
                                        },
                                      )
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      GestureDetector(child: Icon(icons[1],color: Colors.green[900],size: 30,),
                                        onTap: (){
                                          updateClass(state, 2);
                                        },)
                                    ],
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      GestureDetector(child: Icon(icons[2],color: Colors.green[900],size: 30,),
                                        onTap: (){
                                          updateClass(state, 3);
                                        },)
                                    ],
                          ...
                          builder:(context,state){
                            return Container(
                              ...
                              child: Column(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  Text('CHOOSE PASSENGERS',style: TextStyle(
                                      fontWeight: FontWeight.w900,
                                      color: Colors.blue,
                                      fontSize: 20
                                  ),),
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          Row(
                                            children: [
                                              Text('Infants',style: TextStyle(
                                                  color: Colors.black,
                                                  fontWeight: FontWeight.w900,
                                                  fontSize: 20
                                              ),),
                                              Text('(bellow 2y)',style: TextStyle(
                                                  color:Colors.grey[800],
                                                  fontSize: 20,
                                                  fontWeight: FontWeight.w700
                                              ),)
  ...
  Future<Null> updated(StateSetter updateState,int fun,int pass) async {
    updateState(() {
      if(fun==1){
        if(pass==1 && _noAdult>0)
          _noAdult--;
        if(pass==2 && _noChild>0)
          _noChild--;
        if(pass==3 && _noInfants>0)
          _noInfants--;
      }
      else{
        if(pass==1)
